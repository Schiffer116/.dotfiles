...
vim.keymap.set({"n", "i", "v"}, "<M-1>", "<cmd>LualineBuffersJump 1<CR>")
vim.keymap.set({"n", "i", "v"}, "<M-2>", "<cmd>LualineBuffersJump 2<CR>")
vim.keymap.set({"n", "i", "v"}, "<M-3>", "<cmd>LualineBuffersJump 3<CR>")
vim.keymap.set({"n", "i", "v"}, "<M-4>", "<cmd>LualineBuffersJump 4<CR>")
vim.keymap.set({"n", "i", "v"}, "<M-5>", "<cmd>LualineBuffersJump 5<CR>")
vim.keymap.set({"n", "i", "v"}, "<M-6>", "<cmd>LualineBuffersJump 6<CR>")
vim.keymap.set({"n", "i", "v"}, "<M-7>", "<cmd>LualineBuffersJump 7<CR>")
vim.keymap.set({"n", "i", "v"}, "<M-8>", "<cmd>LualineBuffersJump 8<CR>")
vim.keymap.set({"n", "i", "v"}, "<M-9>", "<cmd>LualineBuffersJump 9<CR>")
vim.keymap.set({"n", "i", "v"}, "<M-0>", "<cmd>LualineBuffersJump 10<CR>")
